...
export function copy(from, to, options = {}) {
    ...
    assert(options.ignoreNoMatch || foundFiles.length > 0, 'Trying to copy from a source that does not exist: ' + from.toString());
